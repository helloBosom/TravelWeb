...
var webFXTreeConfig = {
    rootIcon        : '../images/frame/tree/foldericon.gif',
    openRootIcon    : '../images/frame/tree/openfoldericon.gif',
    folderIcon      : '../images/frame/tree/foldericon.gif',
    openFolderIcon  : '../images/frame/tree/openfoldericon.gif',
    fileIcon        : '../images/frame/tree/file.gif',
    iIcon           : '../images/frame/tree/I.gif',
    lIcon           : '../images/frame/tree/L.gif',
    lMinusIcon      : '../images/frame/tree/Lminus.gif',
    lPlusIcon       : '../images/frame/tree/Lplus.gif',
    tIcon           : '../images/frame/tree/T.gif',
    tMinusIcon      : '../images/frame/tree/Tminus.gif',
    tPlusIcon       : '../images/frame/tree/Tplus.gif',
    blankIcon       : '../images/frame/tree/blank.gif',
...
function WebFXTreeAbstractNode(sText, sAction, sOther) {
    this.childNodes = [];
    this.other = sOther;
...
function WebFXTreeItem(sText, sAction, eParent, sOther, isFolder, sIcon, sOpenIcon) {
    this.base = WebFXTreeAbstractNode;
    this.base(sText, sAction, sOther);
...
WebFXTreeItem.prototype.remove = function() {
    ...
    if ((prevSibling == parentNode) && !(parentNode.childNodes.length)) {
        ...
        //当删除到只有根节点的时候，下面的方法有异常。所以加个try catch (hezhenfeng)
        try {

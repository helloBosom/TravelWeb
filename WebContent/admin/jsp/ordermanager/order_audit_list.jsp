...
<body>
  ...
  <table width="100%" align="center" class="table-list">
    ...
    <tr>
      <td bgcolor="#FFFFFF">
      <form name="query" action="<%=path%>/order/querybypage.do" method="post">
        <table align="center" class="table-form">
          <tr>
            <td colspan="7" class="table-title"> 业务系统订单查询</td>
          <tr>
                	...
                	<c:otherwise>
                		<c:forEach var="v"  items="${orders}">
                			...
                			<td align="center"> <input type="checkbox" name="checkbox" value="checkbox"> </td>
                               ...
                               <td height="28">${v[6] }</td>
                               <td height="28">${v[7] }</td>
                               <td height="28"><a href = "<%=path%>/order/${v[0]}/queryorderbyid.do">查看详情</td> 
                               <c:if test="${v[8]=='1'}">
                               ...
                               <td height="28"><a href = "<%=path%>/order/${v[0]}/checkorder.do">审核</td>

...
<body>
<a href="<%=path%>/route/routeAndProduct.do"><input type="submit" name="button" value="route"></a>
<hr>
...
<form action="<%=path%>/customer/customerlogin.do" method="post">
    customername:<input type="text" name="customername" onblur="isNullName(this,'name');"><span id="name"></span><br>
    password:<input type="possword" name="password" onblur="isNullName(this,'pwd');"><span id="pwd"></span>

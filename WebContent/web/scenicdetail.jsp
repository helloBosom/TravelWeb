...
<div class="main">
  ...
  <div class="ny_lylb">
    <div class="ny_lylb_top">
        <ul>
          <li><span>当前位置：<a href="#" target="_blank">首页</a> -&gt; <a href="#" target="_blank">景区简介</a></span>景区简介</li>
        </ul>
        </div>
    ...
    <td><a  href="<%=path%>/comment/addcomm.do?spaceId=${viewspace.spaceId}">用户评价</a></td>
       ...
       <div class="ny_lynr_xcap_nr">
         ...
         <table align="center" border="1" bordercolor="#d1d1d1" width="680">
           <tbody>
           <tr>
             <td align="center" width="70">景点图片</td>
             <td align="center" width="70">景点名称</td>
			 <td align="center" width="450">景点介绍</td>
             <td align="center" width="70">景点票价</td>
           </tr>
           <c:choose>
           <c:when test="${empty viewspace.viewPoints}">
           <tr>no data</tr>
           </c:when>
           <c:otherwise>
           <c:forEach var="v" items="${viewspace.viewPoints }">
           <tr><td align="center"><img width="40px" alt="${v.imgFile}" src="<%=path%>/uploads/${v.imgFile}">
           </td><td align="center">${v.pointName}</td>
           <td>${v.description}</td>
           <td align="center">${v.ticketPrice}</td></tr> 
           </c:forEach>
           </c:otherwise>
           </c:choose>

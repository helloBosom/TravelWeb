...
public class AdministratorManageController {
	...
	public ModelAndView addAdministrator(HttpServletRequest request, @RequestParam("name") String name,
	...
	public ModelAndView updateAdministratorById(HttpServletRequest request, @RequestParam("id") int id,
			@RequestParam("name") String name, @RequestParam("loginname") String loginName,

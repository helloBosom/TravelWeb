...
import com.cissst.software.service.impl.CityService;
import com.cissst.software.comm.CommonConstant;
import com.cissst.software.model.*;
...
public class ViewManageController {
	...
	// 显示所有景区的列表
		...
		public String queryViewSpaces(HttpServletRequest request,
			...
			List<Object> obj=viewSpaceService.count(spaceName);
	...
	@RequestMapping(value="/{id}/updatepoint",method=RequestMethod.POST)
		public String updatepoint(HttpServletRequest request,@PathVariable Integer id,
		...
		public String listViewSpace(HttpServletRequest request,
				@RequestParam(value="currenpage",defaultValue="1") int currenpage) {
			...
			Object[] param={"%%"};
			List<Object> obj=viewSpaceService.count("");
